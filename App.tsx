    ...
    <div className="min-h-screen font-sans text-slate-800">
      ...
      <main className="p-4 sm:p-6 md:p-8 max-w-4xl mx-auto">
        {view === 'form' && (
          <Card>
            <div className="p-6">
              <h2 className="text-2xl font-bold text-slate-700 mb-2">Registrar Nueva Recepción</h2>
              <p className="text-slate-500 mb-6">Complete todos los campos para registrar la recepción de mercancía.</p>
      ...
      <footer className="text-center p-4 text-sm text-slate-500">
        © {new Date().getFullYear()} Reporte T1. Una herramienta para simplificar la logística.
      </footer>
    </div>
  );
};
